    ...
    return ( 
        <>
            ...
            <div className="flex flex-col justify-center h-lvh">
                <CircleImage />
                <h1 className="mb-4 text-2xl leading-tight text-center md:text-4xl md:mb-5">
                    Algunos comentarios
                    <span className="block font-bold text-secondary mb-6">
                       de personas que vieron mi trabajo / trabajaron conmigo 
                    </span>                  
                </h1>
                            ...
                            >
                                {dataTestimonials.map(({id, name, description, imageUrl})=>(
                                    <SwiperSlide key={id}>
                                        ...
                                        <h4 className="text-center mt-5"><b>{name}</b></h4>
